...
- [`./monitoring-shell-runtime-hardening.md`](./monitoring-shell-runtime-hardening.md) - shipped stability hardening notes for route-aware async rendering and jobs-scoped preview cache behavior in the monitoring shell
