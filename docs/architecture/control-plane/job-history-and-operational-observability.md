...
- control-plane launched worker processes can use a dedicated worker metadata datasource URL and vendor-valid worker connection-init SQL when needed, reducing trigger-now contention with control-plane retained metadata writes
