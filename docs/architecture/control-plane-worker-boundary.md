...
That boundary is described in [`runtime-flow.md`](runtime-flow.md) and strengthened in [`scenario-driven-runtime-direction.md`](scenario-driven-runtime-direction.md).
