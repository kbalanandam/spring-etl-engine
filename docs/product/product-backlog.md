...
| [B2](backlog-items/B2-configurable-retry-policy-support.md) | Introduce configurable retry policy support where appropriate | Epic B | P1 | In Progress | M1 | B1 | Kickoff started after B1 completion: contract-first retry boundaries remain narrow, evidence-first, and explicitly separated from reject/skip semantics |
