...
| [A7b](backlog-items/etl-core/A7b-custom-step-context-outcome-and-failure-finalization-follow-on.md) | Extend custom-step context bridge, outcome mapping, and failure-finalization contract | Epic A | P1 | In Progress | M2 | A7, D1 | Same-release delivery in progress for typed context handoff validation, explicit `CONTINUE/STOP/FAIL` mapping, and bounded failure-finalizer hooks |
