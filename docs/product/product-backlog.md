...
| [R3](backlog-items/scheduler/R3-jpa-hibernate-entities-and-repositories-for-control-plane-history.md) | Add JPA/Hibernate entities and repositories for control-plane history | Epic R | P1 | In Progress | M3 | R1, R2, S4 | Active first implementation slice now focuses on portable persistence internals while preserving stable external IDs and read-model behavior |
