 ...
 */
public final class RuntimeConfigValidation {
    ...
    public RuntimeConfigValidation(ValidationRuleEvaluator validationRuleEvaluator,
    ...
    public void validateSelectedTargetConfigs(TargetWrapper targetWrapper, String scenarioName, String targetConfigPath) {
    ...
    public void validateProcessorConfig(ProcessorConfig config,
                                        String scenarioName,
