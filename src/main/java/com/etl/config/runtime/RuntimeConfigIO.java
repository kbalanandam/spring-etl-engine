 ...
 */
public final class RuntimeConfigIO {

    private RuntimeConfigIO() {
    }

    public static String resolveReferencedPath(Path jobConfigDirectory, String configuredPath, String propertyName) {
    ...
    public static Path parentDirectory(String resolvedConfigPath) {
        Path absolutePath = Path.of(resolvedConfigPath).toAbsolutePath().normalize();
        Path parent = absolutePath.getParent();
        return parent == null ? absolutePath : parent;
    }

    public static void normalizeSourceConfigPaths(SourceWrapper sourceWrapper, Path configDirectory) {
    ...
    public static void normalizeTargetConfigPaths(TargetWrapper targetWrapper, Path configDirectory) {
    ...
    public static void normalizeProcessorConfigPaths(ProcessorConfig processorConfig, Path configDirectory) {
    ...
    public static List<ColumnConfig> copyColumns(List<? extends FieldDefinition> fields) {
