...
import static com.etl.config.runtime.RuntimeConfigIO.copyColumns;

/**
 * Applies generated package-name defaults for source/target config models.
 */
public final class RuntimePackageDefaults {

    private RuntimePackageDefaults() {
    }

    public static void applyDefaultSourcePackages(SourceWrapper sourceWrapper, String scenarioName) {
    ...
    public static void applyDirectConfigSourcePackages(SourceWrapper sourceWrapper) {
        if (sourceWrapper == null || sourceWrapper.getSources() == null) {
            return;
        }
    ...
    public static void applyDefaultTargetPackages(TargetWrapper targetWrapper, String scenarioName) {
    ...
    public static void applyDirectConfigTargetPackages(TargetWrapper targetWrapper) {
        if (targetWrapper == null || targetWrapper.getTargets() == null) {
            return;
        }
