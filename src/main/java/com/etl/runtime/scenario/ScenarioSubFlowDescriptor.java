 ...
 */
public record ScenarioSubFlowDescriptor(
String subFlowName,
int subFlowOrder,
...
public ScenarioSubFlowDescriptor {
...
throw new IllegalArgumentException("initialStatus must not be null.");
        ...
        control = control == null ? ScenarioSubFlowControlDescriptor.defaultSequentialControl(!normalizeList(consumesHandoffAliases).isEmpty()) : control;
