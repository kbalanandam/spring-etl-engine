 ...
 */
public record ScenarioStepDescriptor(
		String stepName,
		int stepOrder,
		String sourceName,
		String targetName,
		...
		String displayName,
		String flowSummary,
		ScenarioStepInputDescriptor input,
		ScenarioStepOutputDescriptor output,
		SourceConfig sourceConfig,
		TargetConfig targetConfig,
		ProcessorConfig.EntityMapping processorMapping,
		ScenarioStepModelDescriptor modelDescriptor,
		ScenarioStepExecutionHints executionHints,
		ScenarioStepValidationSummary validationSummary
) {

	public ScenarioStepDescriptor {
