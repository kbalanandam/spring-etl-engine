-- Baseline retained control-plane schema for MySQL.
-- Keep vendor-specific syntax here; portable schema intent is tracked in docs/architecture/control-plane/control-plane-local-relational-schema.md.
...
CREATE UNIQUE INDEX idx_log_checkpoint_log_path_key ON controlplane_log_checkpoint (log_path_key);
...
INSERT INTO controlplane_pk_sequence (sequence_name, next_value, updated_at, created_by, updated_by) VALUES
    ('controlplane_schedule_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    ('controlplane_trigger_event_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    ('controlplane_run_summary_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    ('controlplane_run_record_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    ('controlplane_step_record_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    ('controlplane_artifact_record_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    ('controlplane_attempt_link_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    ('controlplane_checkpoint_anchor_pk', 1, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap');
...
INSERT INTO controlplane_trigger_source (
    ...
    (1, 'MANUAL', 'Manual', 'Ad hoc operator or API-triggered launch', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    (2, 'SCHEDULE', 'Schedule', 'Native scheduler-origin launch', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap'),
    (3, 'EVENT', 'Event', 'File watcher or external event-origin launch', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'spring-etl-engine-bootstrap', 'spring-etl-engine-bootstrap');
