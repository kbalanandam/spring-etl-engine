...
@SpringBootTest(
        ...
        properties = {
                ...
                "spring.datasource.url=jdbc:h2:mem:run-summary-api-jpa-parity-postgres;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE",
...
class RunSummaryApiJpaParityPostgresModeIntegrationTest {
    ...
    @Test
    void stepAndArtifactEndpointsReturnJpaBackedParityShapeInPostgresMode() throws Exception {
        long jobExecutionId = 1001L;
        runSummaryRegistry.upsert(new RunSummaryView(
                "customer-load",
                jobExecutionId,
                "COMPLETED",
                LocalDateTime.of(2026, 8, 19, 18, 0),
                LocalDateTime.of(2026, 8, 19, 18, 2),
                120L,
                50L,
                49L,
                1L,
        ...
        stepRecord.setStepRecordPk(18001L);
        stepRecord.setStepRecordId("sr-" + runRecord.getRunRecordPk() + "-api-postgres");
        ...
        stepRecord.setStartedAt(LocalDateTime.of(2026, 8, 19, 18, 0, 10));
        stepRecord.setFinishedAt(LocalDateTime.of(2026, 8, 19, 18, 1, 40));
        stepRecord.setDurationSeconds(90L);
        stepRecord.setReadCount(50L);
        stepRecord.setWriteCount(49L);
        stepRecord.setFilterCount(1L);
        stepRecord.setSkipCount(0L);
        stepRecord.setRollbackCount(0L);
        stepRecord.setRejectedCount(1L);
        stepRecord.setCreatedAt(LocalDateTime.of(2026, 8, 19, 18, 2));
        stepRecord.setUpdatedAt(LocalDateTime.of(2026, 8, 19, 18, 2));
        ...
        artifactRecord.setArtifactRecordPk(19001L);
        artifactRecord.setArtifactRecordId("ar-" + runRecord.getRunRecordPk() + "-api-postgres");
        ...
        artifactRecord.setArtifactPath("C:/output/rejects/customer-load-postgres.csv");
        artifactRecord.setCreatedAt(LocalDateTime.of(2026, 8, 19, 18, 2));
        artifactRecord.setUpdatedAt(LocalDateTime.of(2026, 8, 19, 18, 2));
        ...
        mockMvc.perform(get("/api/v1/runs/{jobExecutionId}/step-records", jobExecutionId)
                ...
                .andExpect(jsonPath("$.items[0].readCount").value(50))
        ...
        mockMvc.perform(get("/api/v1/runs/{jobExecutionId}/artifact-records", jobExecutionId)
                ...
                .andExpect(jsonPath("$.items[0].artifactPath").value("C:/output/rejects/customer-load-postgres.csv"));
    }
}
